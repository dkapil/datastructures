...
import disjointset.apps.ConnectedComponentsLinkedList;
...
public class ConnectedComponentsLinkedListDemo {
	public static void main(String[] args) {
		...
		ConnectedComponentsLinkedList<String, Integer> connectedComponents = new ConnectedComponentsLinkedList<>(graph, disjointSet);
